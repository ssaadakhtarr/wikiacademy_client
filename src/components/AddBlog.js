...
function AddBlog() {
  ...
  const nowEnable =
    ...
    blogDesc.length > 130 &&
    blogImg.length > 0 &&
    blogMaterial.length > 500;
  const postBlog = () => {
    Axios.post(`${routes}/addBlog`, {
      blogTitle: blogTitle,
      blogDesc: blogDesc,
      blogImg: blogImg,
  ...
  return (
    <div style={{ backgroundColor: "#141d2b" }}>
      ...
      <Box style={{ padding: " 5% 18%" }}>
        ...
        <br></br>
        <Typography
          style={{ color: "#fff", fontWeight: "bold", textTransform: "none" }}
          variant="h4"
        >
          Blog
        </Typography>
        <Typography
          variant="body2"
          style={{ color: "#9fef00", fontWeight: "normal", fontSize: "14px" }}
        >
        ...
        <br></br>
        <br></br>
        <SendButton disabled={!nowEnable} fullWidth onClick={postBlog}>
          Post Blog
        </SendButton>
      </Box>
    </div>
