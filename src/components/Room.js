    ...
    <br></br>
        ...
        {pageCount === 2 && (
          ...
          <Box style={{backgroundColor: "#1a2332"}} padding={2}>
            {/* Task 1 Description */}
           <Typography variant="h3">Task 1 - {fullDetails[0].taskName}</Typography>
            <Typography variant="body2">{renderHTML(fullDetails[0].taskDescription)}</Typography>
            <hr></hr>
            <br></br>
            {/* Task 1 Questions */}
            <Typography style={{fontWeight: "600"}} variant="h6">Questions</Typography>
            <Typography variant="caption">Answer the questions below to complete this Section</Typography>
            <br></br>
            <br></br>
            ...
            >
              {previousData[0].isAnswered === 1 ? <CheckIcon/> : `Submit`}
            </StyledButton>
            <br></br>
            <br></br>
            <Typography variant="body2">
            ...
            >
              {previousData[1].isAnswered === 1 ? <CheckIcon/> : "Submit"}
            </Button>
            <br></br>
            <br></br>
            <Typography variant="body2">
            ...
            >
              {previousData[2].isAnswered === 1 ? <CheckIcon/> : `Submit`}
            </Button>
            <br></br>
            <br></br>
            <Typography variant="body2">
            ...
            >
              {previousData[3].isAnswered === 1 ? <CheckIcon/> : `Submit`}
            </Button>
            <br></br>
            <br></br>
            <Typography variant="body2">
            ...
            >
              {previousData[4].isAnswered === 1 ? <CheckIcon/> : `Submit`}
            </Button>
            <br></br>
            <br></br>
          </Box>
        ...
        {pageCount === 3 && (
          ...
          <Box style={{backgroundColor: "#1a2332"}} padding={2}>
            {/* Task 2 Description */}
           <Typography variant="h3">Task 2 - {fullDetails[1].taskName}</Typography>
            <Typography variant="body2">{renderHTML(fullDetails[1].taskDescription)}</Typography>
            <hr></hr>
            <br></br>
            {/* Task 2 Questions */}
            <Typography style={{fontWeight: "600"}} variant="h6">Questions</Typography>
            ...
            >
              {previousData[5].isAnswered === 1 ? <CheckIcon/> : `Submit`}
            </StyledButton>
            <br></br>
            <br></br>
            <Typography variant="body2">
            ...
            >
              {previousData[6].isAnswered === 1 ? <CheckIcon/> : "Submit"}
            </Button>
            <br></br>
            <br></br>
            <Typography variant="body2">
            ...
            >
              {previousData[7].isAnswered === 1 ? <CheckIcon/> : `Submit`}
            </Button>
            <br></br>
            <br></br>
            <Typography variant="body2">
            ...
            >
              {previousData[8].isAnswered === 1 ? <CheckIcon/> : `Submit`}
            </Button>
            <br></br>
            <br></br>
            <Typography variant="body2">
            ...
            >
              {previousData[9].isAnswered === 1 ? <CheckIcon/> : `Submit`}
            </Button>
            <br></br>
            <br></br>
          </Box>
        ...
        {pageCount === 4 && (
          ...
          <Box style={{backgroundColor: "#1a2332"}} padding={2}>
            {/* Task 3 Description */}
           <Typography variant="h3">Task 3 - {fullDetails[2].taskName}</Typography>
            <Typography variant="body2">{renderHTML(fullDetails[2].taskDescription)}</Typography>
            <hr></hr>
            <br></br>
            {/* Task 3 Questions */}
            <Typography style={{fontWeight: "600"}} variant="h6">Questions</Typography>
            ...
            >
              {previousData[11].isAnswered === 1 ? <CheckIcon/> : "Submit"}
            </Button>
            <br></br>
            <br></br>
            <Typography variant="body2">
            ...
            >
              {previousData[12].isAnswered === 1 ? <CheckIcon/> : `Submit`}
            </Button>
            <br></br>
            <br></br>
            <Typography variant="body2">
            ...
            >
              {previousData[13].isAnswered === 1 ? <CheckIcon/> : `Submit`}
            </Button>
            <br></br>
            <br></br>
            <Typography variant="body2">
            ...
            >
              {previousData[14].isAnswered === 1 ? <CheckIcon/> : `Submit`}
            </Button>
            <br></br>
            <br></br>
          </Box>
        ...
        {pageCount === 5 && (
          ...
          <Box style={{backgroundColor: "#1a2332"}} padding={2}>
            {/* Task 4 Description */}
           <Typography variant="h3">Task 4 - {fullDetails[3].taskName}</Typography>
            <Typography variant="body2">{renderHTML(fullDetails[3].taskDescription)}</Typography>
            <hr></hr>
            <br></br>
            {/* Task 4 Questions */}
            <Typography style={{fontWeight: "600"}} variant="h6">Questions</Typography>
            ...
            >
              {previousData[15].isAnswered === 1 ? <CheckIcon/> : `Submit`}
            </StyledButton>
            <br></br>
            <br></br>
            <Typography variant="body2">
            ...
            >
              {previousData[16].isAnswered === 1 ? <CheckIcon/> : "Submit"}
            </Button>
            <br></br>
            <br></br>
            <Typography variant="body2">
            ...
            >
              {previousData[17].isAnswered === 1 ? <CheckIcon/> : `Submit`}
            </Button>
            <br></br>
            <br></br>
            <Typography variant="body2">
            ...
            >
              {previousData[18].isAnswered === 1 ? <CheckIcon/> : `Submit`}
            </Button>
            <br></br>
            <br></br>
            <Typography variant="body2">
            ...
            >
              {previousData[19].isAnswered === 1 ? <CheckIcon/> : `Submit`}
            </Button>
            <br></br>
            <br></br>
          </Box>
        ...
        {pageCount === 6 && (
          ...
          <Box style={{backgroundColor: "#1a2332"}} padding={2}>
            {/* Task 5 Description */}
           <Typography variant="h3">Task 5 - {fullDetails[4].taskName}</Typography>
            <Typography variant="body2">{renderHTML(fullDetails[4].taskDescription)}</Typography>
            <hr></hr>
            <br></br>
            {/* Task 5 Questions */}
            <Typography style={{fontWeight: "600"}} variant="h6">Questions</Typography>
            ...
            >
              {previousData[20].isAnswered === 1 ? <CheckIcon/> : `Submit`}
            </StyledButton>
            <br></br>
            <br></br>
            <Typography variant="body2">
            ...
            >
              {previousData[21].isAnswered === 1 ? <CheckIcon/> : "Submit"}
            </Button>
            <br></br>
            <br></br>
            <Typography variant="body2">
            ...
            >
              {previousData[22].isAnswered === 1 ? <CheckIcon/> : `Submit`}
            </Button>
            <br></br>
            <br></br>
            <Typography variant="body2">
            ...
            >
              {previousData[23].isAnswered === 1 ? <CheckIcon/> : `Submit`}
            </Button>
            <br></br>
            <br></br>
            <Typography variant="body2">
            ...
            >
              {previousData[24].isAnswered === 1 ? <CheckIcon/> : `Submit`}
            </Button>
            <br></br>
            <br></br>
          </Box>
        ...
        >
          ...
          {pageCount < 6 && (
            <StyledButton style={{ marginLeft: "5px" }} onClick={showTasks}>
              Next
            </StyledButton>
          )}
        </Box>
